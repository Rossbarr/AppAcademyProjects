...
ActiveRecord::Schema.define(version: 2021_01_28_160645) do
  ...
  create_table "tag_topics", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tag"], name: "index_tag_topics_on_tag"
  end
  ...
  create_table "taggings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["shortened_url_id", "tag_topic_id"], name: "index_taggings_on_shortened_url_id_and_tag_topic_id"
  end
